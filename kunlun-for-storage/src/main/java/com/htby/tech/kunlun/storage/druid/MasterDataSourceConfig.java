package com.htby.tech.kunlun.storage.druid;
...
@Slf4j
@Configuration
@MapperScan(basePackages = {"com.htby.tech.kunlun.storage.dao"}, sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterDataSourceConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") DataSource masterDataSource) throws Exception {
        ...
        log.info("masterSqlSessionFactory-start;");
