package com.htby.tech.kunlun.platform.web.exception;
...
import com.htby.tech.kunlun.runtime.base.exception.UserException;
...
public class DefExceptionHandler {
    ...
    public Object execute(HttpServletRequest httpServletRequest, Exception e) {
        ...
        if (e instanceof UserException) {
            apiBaseResult = new ApiBaseResult(ApiCallReturnCodeEnum.USER_ERROR.getCode(), e.getMessage());
